...
LOCK TABLES `hardware_change_events` WRITE;
/*!40000 ALTER TABLE `hardware_change_events` DISABLE KEYS */;
/*!40000 ALTER TABLE `hardware_change_events` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `hardware_change_event_data`
--
...
LOCK TABLES `hardware_change_events_data` WRITE;
/*!40000 ALTER TABLE `hardware_change_events_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `hardware_change_events_data` ENABLE KEYS */;
UNLOCK TABLES;
